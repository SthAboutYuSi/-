# -*- coding: utf-8 -*-
# @Author: yusi
# @Date:   2019-08-23 11:41:20
# @Last Modified by:   yusi
# @Last Modified time: 2019-08-23 14:21:55
...
class TestPlayerPhoneRegistedCheck(unittest.TestCase):
	"""验证手机号是否注册接口"""
	API_URL = Config().get('OpenPlatform_API').get('Player').get('CheckPhoneRegisted')
	...
	def test_PlayerCheckPhoneRegisted01(self):
		"""批量验证手机号是否注册接口容错"""
		datas = ExcelReader(self.excel,sheet='CheckPhoneRegisted').data
...
if __name__ == '__main__':
	...
	suite.addTest(TestPlayerPhoneRegistedCheck('test_PlayerCheckPhoneRegisted01'))
