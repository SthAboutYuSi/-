...
class TestUserGet(unittest.TestCase):
	"""根据ID获取账号信息接口"""
	API_URL = Config().get('OpenPlatform_API').get('User').get('UserGet')
	...
	def test_UserGet01(self):
		"""批量验证根据ID获取账号信息接口容错"""
		datas = ExcelReader(self.excel,sheet='UserGet').data
...
if __name__ == '__main__':
	...
	suite.addTest(TestUserGet('test_UserGet01'))
