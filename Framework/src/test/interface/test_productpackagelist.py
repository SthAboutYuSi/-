...
# @Last Modified time: 2019-09-18 11:36:08
...
class TestProductPackageList(unittest.TestCase):
	"""分包列表接口"""
	API_URL = Config().get('OpenPlatform_API').get('ProductPackage').get('ProductPackageList')
	...
	def test_ProductPackageList01(self):
		"""批量验证分包列表接口容错"""
		datas = ExcelReader(self.excel,sheet='ProductPackageList').data
...
if __name__ == '__main__':
	...
	suite.addTest(TestProductPackageList('test_ProductPackageList01'))
