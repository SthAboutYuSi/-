...
# @Last Modified time: 2019-09-29 19:56:30
...
class TestPlayerUnFrozen(unittest.TestCase):
	"""解冻账户接口"""
	API_URL = Config().get('OpenPlatform_API').get('Player').get('UnFrozen')
	...
	def test_UnFrozen01(self):
		"""批量验证解冻账户接口容错"""
		datas = ExcelReader(self.excel,sheet='UnFrozen').data
...
if __name__ == '__main__':
	...
	suite.addTest(TestPlayerUnFrozen('test_UnFrozen01'))
