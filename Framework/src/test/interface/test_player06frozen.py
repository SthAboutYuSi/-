...
# @Last Modified time: 2019-09-29 16:51:09
...
class TestPlayerFrozen(unittest.TestCase):
	"""永久冻结账户接口"""
	API_URL = Config().get('OpenPlatform_API').get('Player').get('Frozen')
	...
	def test_Frozen01(self):
		"""批量验证永久冻结账户接口容错"""
		datas = ExcelReader(self.excel,sheet='Frozen').data
...
if __name__ == '__main__':
	...
	suite.addTest(TestPlayerFrozen('test_Frozen01'))
