...
class TestProductPackageSimpleInfo(unittest.TestCase):
	"""添加获取分包号的简单信息接口"""
	API_URL = Config().get('OpenPlatform_API').get('ProductPackage').get('ProductPackageSimpleInfo')
...
if __name__ == '__main__':
	...
	suite.addTest(TestProductPackageSimpleInfo('test_ProductPackageSimpleInfo01'))
